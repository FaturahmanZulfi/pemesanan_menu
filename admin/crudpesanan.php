...
require "../db_func.php";
session_start();
$pesanan = select('pesanan','kode_pesanan,nama,SUM(total_harga) as total_harga','WHERE status = "belum dibayar" GROUP BY kode_pesanan;');
...
if(isset($_POST['confirm'])){
    ...
    if (update("pesanan","status = 'sudah dibayar',pesanan_selesai = CURRENT_TIMESTAMP","WHERE kode_pesanan = '$kode_pesanan'") === true) {
        header("Location:crudpesanan.php");
    }
}
...
<body id="page-top">
                    ...
                    <div class="row">
                        <div class="card shadow mb-4 col-12">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold">Daftar Pesanan Belum Dibayar</h6>
                            </div>
                            <div class="card-body">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post">
                        <input type="hidden" name="kode_pesanan" value="<?= $pesan['kode_pesanan'] ?>">
                        <input type="submit" name="confirm" class="btn btn-success btn-user" value="Konfirmasi">
                    </form>
    ...
    <div class="modal fade" id="deleteModal<?= $pesan["id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form method="post" class="user" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h3 class="modal-title fs-5" id="exampleModalLabel">Yakin Ingin Hapus Pesanan Ini ?</h3>
                    </div>
                    <div class="modal-footer">
